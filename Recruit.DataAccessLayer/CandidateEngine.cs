...
namespace Recruit.DataAccessLayer
{
    public class CandidateEngine
    {
        ...
        /// <summary>
        /// Method used to display all te contents of the table Candidates
        /// </summary>
        /// <returns></returns>
        public List<Candidate> FindByAll()
        {
            ...
            try
            {
                using (IDbConnection database = new SqlConnection(connectionString))
                {
                    ...
                    data = database.Query<Candidate>("select  tbl_candidates.id,tbl_candidates.first_name," +
                        "tbl_candidates.last_name,email,phone,tbl_sources.name as 'source_name',tbl_employees.name as 'emp_ref'," +
                        ...
                        "reason_for_change,notice_period,is_serving_notice,last_working_day,current_location,tbl_process_stages.stage as 'stage' ," +
                        "process_stage_date,process_start_date,process_end_date,tbl_process_statuses.status as 'status',t1.first_name as 'owner'," +
                        "t2.first_name as 'remind',comments,date_of_joining,notes,links_for_interview " +
                        "from tbl_Candidates," +
                        "tbl_sources,tbl_employees,tbl_vacancies,tbl_process_stages,tbl_process_statuses,tbl_owners as t1, tbl_owners as t2" +
        ...
        /// <summary>
        /// method used to display contents for the specified primary key
        /// </summary>
        ...
        /// <summary>
        /// Create and update operations for the the given contents to the table candidates
        /// </summary>
        /// <param name="Entities">contents that is inserted</param>
        /// <returns></returns>
